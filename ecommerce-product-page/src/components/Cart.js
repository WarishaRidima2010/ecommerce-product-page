...
export default function Cart() {
    ...
    return <>
        <article 
            ...
            absolute w-9/12 right-0 top-32 left-8 lg:w-96 lg:left-auto lg:top-20'
            style={{
                zIndex: 1000,
            }}
        >
            ...
            <div className='flex items-center justify-between'>
                ...
                <ul>
                    ...
                    <li className='text-slate-600 text-sm'>$125.00 x 3 
            ...
            <button className='bg-orange-500 py-2 px-4 text-white font-bold rounded-lg 
              shadow mt-5 w-full hover:bg-orange-600 transition-all duration-200'>Checkout
            </button>
